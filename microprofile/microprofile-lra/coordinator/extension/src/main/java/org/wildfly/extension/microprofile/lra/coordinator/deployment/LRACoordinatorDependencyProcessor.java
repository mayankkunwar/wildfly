...
package org.wildfly.extension.microprofile.lra.coordinator.deployment;
...
public class LRACoordinatorDependencyProcessor implements DeploymentUnitProcessor {
    ...
    private void addModuleDependencies(DeploymentUnit deploymentUnit) {
        ...
        moduleSpecification.addSystemDependency(
                cdiDependency(
                        new ModuleDependency(moduleLoader, "io.narayana.lra.coordinator", false, false, true, false)));
