...
public class MicroProfileLRACoordinatorExtension implements Extension {
    ...
    static ResourceDescriptionResolver getResourceDescriptionResolver(final boolean useUnprefixedChildTypes, final String... keyPrefix) {
        ...
        return new StandardResourceDescriptionResolver(prefix.toString(), RESOURCE_NAME, MicroProfileLRACoordinatorExtension.class.getClassLoader(), true, useUnprefixedChildTypes);
    }
    ...
    public void initialize(ExtensionContext extensionContext) {
        ...
        if (cl instanceof ModuleClassLoader) {
            ...
            try {
                Module module = loader.loadModule("io.narayana.lra.coordinator");
        ...
        final ManagementResourceRegistration root = sr.registerSubsystemModel(new MicroProfileLRACoordinatorSubsystemDefinition());
    ...
    public void initializeParsers(ExtensionParsingContext extensionParsingContext) {
        extensionParsingContext.setSubsystemXmlMapping(SUBSYSTEM_NAME, MicroProfileLRACoordinatorParser_1_0.NAMESPACE, CURRENT_PARSER);
    }
}