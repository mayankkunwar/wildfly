...
import static org.wildfly.extension.microprofile.lra.coordinator.MicroProfileLRACoordinatorExtension.WELD_CAPABILITY_NAME;
...
import org.wildfly.extension.microprofile.lra.coordinator.deployment.LRACoordinatorDependencyProcessor;


public class MicroProfileLRACoordinatorSubsystemDefinition extends PersistentResourceDefinition {

    private static final String LRA_COORDINATOR_CAPABILITY_NAME = "org.wildfly.microprofile.lra.coordinator";

    private static final RuntimeCapability<Void> LRA_COORDINATOR_CAPABILITY = RuntimeCapability.Builder
            .of(LRA_COORDINATOR_CAPABILITY_NAME)
            .addRequirements(WELD_CAPABILITY_NAME)
            .addRequirements(LRA_COORDINATOR_CAPABILITY_NAME)
            .build();
    ...
    public MicroProfileLRACoordinatorSubsystemDefinition() {
        super(
                new SimpleResourceDefinition.Parameters(
                        SUBSYSTEM_PATH,
                        MicroProfileLRACoordinatorExtension.getResourceDescriptionResolver(SUBSYSTEM_NAME))
                        .setAddHandler(AddHandler.INSTANCE)
                        .setRemoveHandler(new ReloadRequiredRemoveStepHandler())
                        .setCapabilities(LRA_COORDINATOR_CAPABILITY)
        );
    }
    ...
    public void registerAdditionalRuntimePackages(ManagementResourceRegistration resourceRegistration) {
        resourceRegistration.registerAdditionalRuntimePackages(
                RuntimePackageDependency.required("io.narayana.lra.coordinator"),
        ...
        protected void performBoottime(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
            ...
            context.addStep(new AbstractDeploymentChainStep() {
                public void execute(DeploymentProcessorTarget processorTarget) {
                    ...
                    final int DEPENDENCIES_MICROPROFILE_LRA_COORDINATOR = 6341;

                    processorTarget.addDeploymentProcessor(SUBSYSTEM_NAME, DEPENDENCIES, DEPENDENCIES_MICROPROFILE_LRA_COORDINATOR, new LRACoordinatorDependencyProcessor());
                }
            }, RUNTIME);
